  ...
  <div class="goods">
      ...
      <div class="menu-wrapper" ref="menuScroll">
          <ul>
                ...
                <li class="menu-item" v-for="(item, index) in goods" :class="{'current':currentIndex === index + 1}" :key="index" @click="selectMenu(index+1)">
                    <p class="text">
          ...
          <ul>
            ...
            <li v-for="(item,index) in goods" :key="index" class="food-list food-list-hook">
                ...
                <ul>
                    ...
                    :key="index" class="food-item" @click="showDetail(food)">
